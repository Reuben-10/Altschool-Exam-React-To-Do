...
const TodoDetailPage = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      const foundTodo = storedTodos.find((t: Todo) => t.id === todoId);
          ...
          <>
            <div className="flex flex-col items-center gap-2 w-full">
              ...
              <span className="text-xs text-gray-400 mt-1">
                ...
                Added: {todo?.createdAt && !isNaN(new Date(todo.createdAt).getTime()) ? formatDate(todo.createdAt) : "Date not available"}
              </span>
            </div>
            {/* Status buttons */}
